...
continuous_graph(mlp_predict_31_12_pv, test_y_pv, 'PV power generation in kW via MLP(31.12.2015)', 'Time')
step_graph(mlp_predict_31_12_pv, test_y_pv, 'PV power generation in kW via MLP(31.12.2015)', 'Time')
...
continuous_graph(mlp_predict_31_12_wind, test_y_wind, 'Wind power generation in kW via MLP(31.12.2015)', 'Time')
step_graph(mlp_predict_31_12_wind, test_y_wind, 'Wind power generation in kW via MLP(31.12.2015)', 'Time')
...
mse_pv_mlp = mean_squared_error(test_y_pv, mlp_predict_31_12_pv)
...
mse_wind_mlp = mean_squared_error(test_y_wind, mlp_predict_31_12_wind)
