...
ini_data_prosumers = data_prosumers[105119:140063:4]

# 30.12.2016
prev_day_data_house = data_house[34992:35040:2]
prev_day_data_prosumers = data_prosumers[139967:140063:4]

# 31.12.2016
last_day_data_house = data_house[35040::2]
last_day_data_prosumers = data_prosumers[140063:140159:4]


y_test_house_31_12 = last_day_data_house['Building 1']
y_test_school_31_12 = last_day_data_prosumers['School']
y_test_zoo_31_12 = last_day_data_prosumers['Zoo']
y_test_gym_31_12 = last_day_data_prosumers['Gym']
y_test_event_hall_31_12 = last_day_data_prosumers['Event hall']

load_house_30_12 = np.array(prev_day_data_house['Building 1'])
load_school_30_12 = np.array(prev_day_data_prosumers['School'])
load_zoo_30_12 = np.array(prev_day_data_prosumers['Zoo'])
load_gym_30_12 = np.array(prev_day_data_prosumers['Gym'])
load_event_hall_30_12 = np.array(prev_day_data_prosumers['Event hall'])

# Training data
y_train_house = np.array(ini_data_house['Building 1'])
y_train_school = np.array(ini_data_prosumers['School'])
y_train_zoo = np.array(ini_data_prosumers['Zoo'])
y_train_gym = np.array(ini_data_prosumers['Gym'])
y_train_event_hall = np.array(ini_data_prosumers['Event hall'])
...
time_last_day = np.array(last_day_data_prosumers['Date'])

# Using office load as a feature vector for Pr-2 to Pr-5(School, Zoo, Gym and Event-hall)
x = ini_data_prosumers['Office building']
X = x.values.reshape(-1, 1)

# Using Temperature as a feature vector for Pr-1(House)
x_house = ini_data_house['Temperature']
X_house = x_house.values.reshape(-1, 1)

# Labels
Y_house = ini_data_house['Building 1']
Y_school = ini_data_prosumers['School']
Y_zoo = ini_data_prosumers['Zoo']
Y_gym = ini_data_prosumers['Gym']
Y_hall = ini_data_prosumers['Event hall']

x_test_prosumers_31_12 = last_day_data_prosumers['Office building']
x_test_prosumers_31_12 = x_test_prosumers_31_12.values.reshape(-1, 1)
x_test_house_31_12 = last_day_data_house['Temperature']
x_test_house_31_12 = x_test_house_31_12.values.reshape(-1, 1)


X_train_house, X_test_house, Y_train_house, Y_test_house = train_test_split(X_house, Y_house, test_size=0.25,
                                                                            shuffle=False)
X_train_school, X_test_school, Y_train_school, Y_test_school = train_test_split(X, Y_school, test_size=0.25,
                                                                                shuffle=False)
...
y_predict_31_12_house = linear_model_house.predict(x_test_house_31_12)
...
y_predict_31_12_school = linear_model_school.predict(x_test_prosumers_31_12)
...
y_predict_31_12_zoo = linear_model_zoo.predict(x_test_prosumers_31_12)
...
y_predict_31_12_gym = linear_model_gym.predict(x_test_prosumers_31_12)
...
y_predict_31_12_hall = linear_model_hall.predict(x_test_prosumers_31_12)
...
k_predict_31_12_house = knn_model_house.predict(x_test_house_31_12)
...
k_predict_31_12_school = knn_model_school.predict(x_test_prosumers_31_12)
...
k_predict_31_12_zoo = knn_model_zoo.predict(x_test_prosumers_31_12)
...
k_predict_31_12_gym = knn_model_gym.predict(x_test_prosumers_31_12)
...
k_predict_31_12_hall = knn_model_hall.predict(x_test_prosumers_31_12)
...
gbr_predict_31_12_house = gbr_model_house.predict(x_test_house_31_12)
...
gbr_predict_31_12_school = gbr_model_school.predict(x_test_prosumers_31_12)
...
gbr_predict_31_12_zoo = gbr_model_zoo.predict(x_test_prosumers_31_12)
...
gbr_predict_31_12_gym = gbr_model_gym.predict(x_test_prosumers_31_12)
...
gbr_predict_31_12_hall = gbr_model_hall.predict(x_test_prosumers_31_12)
...
mlp_predict_31_12_house = mlp_house.predict(x_test_house_31_12)
...
mlp_predict_31_12_hall = mlp_hall.predict(x_test_prosumers_31_12)
...
r_predict_31_12_house = ridge_house.predict(x_test_house_31_12)
...
r_predict_31_12_hall = ridge_hall.predict(x_test_prosumers_31_12)
...
lasso_predict_31_12_house = lasso_house.predict(x_test_house_31_12)
...
lasso_predict_31_12_school = lasso_school.predict(x_test_prosumers_31_12)
...
lasso_predict_31_12_zoo = lasso_zoo.predict(x_test_prosumers_31_12)
...
lasso_predict_31_12_gym = lasso_gym.predict(x_test_prosumers_31_12)
...
lasso_predict_31_12_hall = lasso_hall.predict(x_test_prosumers_31_12)

# AKNN on Prosumer-1(House)
plot_values_house = prediction(load_house_30_12, chunks_house)
continuous_graph(plot_values_house, y_test_house_31_12, 'Prosumer-1 power consumption in kW via AKNN(31.12.2016)',
                 'Hour')
step_graph(plot_values_house, y_test_house_31_12, 'Prosumer-1 power consumption in kW via AKNN(31.12.2016)', 'Hour')

# AKNN on Prosumer-2(School)
plot_values_school = prediction(load_school_30_12, chunks_school)
continuous_graph(plot_values_school, y_test_school_31_12, 'Prosumer-2 power consumption in kW via AKNN(31.12.2016)',
                 'Hour')
step_graph(plot_values_school, y_test_school_31_12, 'Prosumer-2 power consumption in kW via AKNN(31.12.2016)', 'Hour')

# AKNN on Prosumer-3(Zoo)
plot_values_zoo = prediction(load_zoo_30_12, chunks_zoo)
continuous_graph(plot_values_zoo, y_test_zoo_31_12, 'Prosumer-3 power consumption in kW via AKNN(31.12.2016)', 'Hour')
step_graph(plot_values_zoo, y_test_zoo_31_12, 'Prosumer-3 power consumption in kW via AKNN(31.12.2016)', 'Hour')

# AKNN on Prosumer-4(Gym)
plot_values_gym = prediction(load_gym_30_12, chunks_gym)
continuous_graph(plot_values_gym, y_test_gym_31_12, 'Prosumer-4 power consumption in kW via AKNN(31.12.2016)', 'Hour')
step_graph(plot_values_gym, y_test_gym_31_12, 'Prosumer-4 power consumption in kW via AKNN(31.12.2016)', 'Hour')

# AKNN on Prosumer-5(Event hall)
plot_values_hall = prediction(load_event_hall_30_12, chunks_event_hall)
continuous_graph(plot_values_hall, y_test_event_hall_31_12, 'Prosumer-5 power consumption in kW via AKNN(31.12.2016)',
                 'Hour')
step_graph(plot_values_hall, y_test_event_hall_31_12, 'Prosumer-5 power consumption in kW via AKNN(31.12.2016)', 'Hour')
...
plt.step(hour, y_test_house_31_12.values, label='A. Pr-1')
plt.step(hour, plot_values_school, label='P. Pr-2')
plt.step(hour, y_test_school_31_12.values, label='A. Pr-2')
plt.step(hour, plot_values_zoo, label='P. Pr-3')
plt.step(hour, y_test_zoo_31_12.values, label='A. Pr-3')
plt.step(hour, plot_values_gym, label='P. Pr-4')
plt.step(hour, y_test_gym_31_12.values, label='A. Pr-4')
plt.step(hour, plot_values_hall, label='P. Pr-5')
plt.step(hour, y_test_event_hall_31_12.values, label='A. Pr-5')
plt.ylabel('Power (kW)')
plt.xticks([0, 5, 10, 15, 20],
           ['00:00', '05:00', '10:00', '15:00', '20:00'])
plt.xlabel('Hour')
...
plt.step(hour, y_test_house_31_12.values, label='Actual')
...
plt.ylabel('Pr-1 load in kW on 31.12.2016')
plt.xticks([0, 5, 10, 15, 20],
           ['00:00', '05:00', '10:00', '15:00', '20:00'])
plt.xlabel('Hour')
plt.legend()
...
plt.step(hour, y_test_school_31_12.values, label='Actual')
...
plt.ylabel('Pr-2 load in kW on 31.12.2016')
plt.xticks([0, 5, 10, 15, 20],
           ['00:00', '05:00', '10:00', '15:00', '20:00'])
plt.xlabel('Hour')
plt.legend()
...
plt.step(hour, y_test_zoo_31_12.values, label='Actual')
...
plt.ylabel('Pr-3 load in kW on 31.12.2016')
plt.xticks([0, 5, 10, 15, 20],
           ['00:00', '05:00', '10:00', '15:00', '20:00'])
plt.xlabel('Hour')
plt.legend()
...
plt.step(hour, y_test_gym_31_12.values, label='Actual')
...
plt.ylabel('Pr-4 load in kW on 31.12.2016')
plt.xticks([0, 5, 10, 15, 20],
           ['00:00', '05:00', '10:00', '15:00', '20:00'])
plt.xlabel('Hour')
plt.legend()
...
plt.step(hour, y_test_event_hall_31_12.values, label='Actual')
...
plt.ylabel('Pr-5 load in kW on 31.12.2016')
plt.xticks([0, 5, 10, 15, 20],
           ['00:00', '05:00', '10:00', '15:00', '20:00'])
plt.xlabel('Hour')
plt.legend()
...
# AKNN Pr-1
mean_house = np.mean(y_test_house_31_12)
mse_house_aknn = mean_squared_error(y_test_house_31_12, plot_values_house)
...
mse_house_lr = mean_squared_error(y_test_house_31_12, y_predict_31_12_house)
...
# KNN Pr-1
mse_house_knn = mean_squared_error(y_test_house_31_12, k_predict_31_12_house)
...
# GBR Pr-1
mse_house_gbr = mean_squared_error(y_test_house_31_12, gbr_predict_31_12_house)
...
# MLP Pr-1
mse_house_mlp = mean_squared_error(y_test_house_31_12, mlp_predict_31_12_house)
...
# Ridge Pr-1
mse_house_r = mean_squared_error(y_test_house_31_12, r_predict_31_12_house)
...
# Lasso Pr-1
mse_house_lasso = mean_squared_error(y_test_house_31_12, lasso_predict_31_12_house)
...
# AKNN Pr-2
mean_school = np.mean(y_test_school_31_12)
mse_school_aknn = mean_squared_error(y_test_school_31_12, plot_values_school)
...
# LR Pr-2
mse_school_lr = mean_squared_error(y_test_school_31_12, y_predict_31_12_school)
...
# KNN Pr-2
mse_school_knn = mean_squared_error(y_test_school_31_12, k_predict_31_12_school)
...
# GBR Pr-2
mse_school_gbr = mean_squared_error(y_test_school_31_12, gbr_predict_31_12_school)
...
# MLP Pr-2
mse_school_mlp = mean_squared_error(y_test_school_31_12, mlp_predict_31_12_school)
...
# Ridge Pr-2
mse_school_r = mean_squared_error(y_test_school_31_12, r_predict_31_12_school)
...
# Lasso Pr-2
mse_school_lasso = mean_squared_error(y_test_school_31_12, lasso_predict_31_12_school)
...
# AKNN Pr-3
mean_zoo = np.mean(y_test_zoo_31_12)
mse_zoo_aknn = mean_squared_error(y_test_zoo_31_12, plot_values_zoo)
...
# LR Pr-3
mse_zoo_lr = mean_squared_error(y_test_zoo_31_12, y_predict_31_12_zoo)
...
# KNN Pr-3
mse_zoo_knn = mean_squared_error(y_test_zoo_31_12, k_predict_31_12_zoo)
...
# GBR Pr-3
mse_zoo_gbr = mean_squared_error(y_test_zoo_31_12, gbr_predict_31_12_zoo)
...
# MLP Pr-3
mse_zoo_mlp = mean_squared_error(y_test_zoo_31_12, mlp_predict_31_12_zoo)
...
# Ridge Pr-3
mse_zoo_r = mean_squared_error(y_test_zoo_31_12, r_predict_31_12_zoo)
...
# Lasso Pr-3
mse_zoo_lasso = mean_squared_error(y_test_zoo_31_12, lasso_predict_31_12_zoo)
...
# AKNN Pr-4
mean_gym = np.mean(y_test_gym_31_12)
mse_gym_aknn = mean_squared_error(y_test_gym_31_12, plot_values_gym)
...
# LR Pr-4
mse_gym_lr = mean_squared_error(y_test_gym_31_12, y_predict_31_12_gym)
...
# KNN Pr-4
mse_gym_knn = mean_squared_error(y_test_gym_31_12, k_predict_31_12_gym)
...
# GBR Pr-4
mse_gym_gbr = mean_squared_error(y_test_gym_31_12, gbr_predict_31_12_gym)
...
# MLP Pr-4
mse_gym_mlp = mean_squared_error(y_test_gym_31_12, mlp_predict_31_12_gym)
...
# Ridge Pr-4
mse_gym_r = mean_squared_error(y_test_gym_31_12, r_predict_31_12_gym)
...
# Lasso Pr-4
mse_gym_lasso = mean_squared_error(y_test_gym_31_12, lasso_predict_31_12_gym)
...
# AKNN Pr-5
mean_event_hall = np.mean(y_test_event_hall_31_12)
mse_event_hall_aknn = mean_squared_error(y_test_event_hall_31_12, plot_values_hall)
...
# LR Pr-5
mse_event_hall_lr = mean_squared_error(y_test_event_hall_31_12, y_predict_31_12_hall)
...
# KNN Pr-5
mse_event_hall_knn = mean_squared_error(y_test_event_hall_31_12, k_predict_31_12_hall)
...
# GBR Pr-5
mse_event_hall_gbr = mean_squared_error(y_test_event_hall_31_12, gbr_predict_31_12_hall)
...
# MLP Pr-5
mse_event_hall_mlp = mean_squared_error(y_test_event_hall_31_12, mlp_predict_31_12_hall)
...
# Ridge Pr-5
mse_event_hall_r = mean_squared_error(y_test_event_hall_31_12, r_predict_31_12_hall)
...
# Lasso Pr-5
mse_event_hall_lasso = mean_squared_error(y_test_event_hall_31_12, lasso_predict_31_12_hall)
